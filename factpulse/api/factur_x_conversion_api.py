...
class FacturXConversionApi:
    ...
    @validate_call
    def resume_conversion_async_api_v1_convert_conversion_id_resume_async_post(
        self,
        conversion_id: Annotated[StrictStr, Field(description="Conversion ID returned by POST /convert (UUID format)")],
        convert_resume_request: ConvertResumeRequest,
        _request_timeout: Union[
        ...
        _param = self._resume_conversion_async_api_v1_convert_conversion_id_resume_async_post_serialize(
            conversion_id=conversion_id,
            convert_resume_request=convert_resume_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def resume_conversion_async_api_v1_convert_conversion_id_resume_async_post_with_http_info(
        self,
        conversion_id: Annotated[StrictStr, Field(description="Conversion ID returned by POST /convert (UUID format)")],
        convert_resume_request: ConvertResumeRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def resume_conversion_async_api_v1_convert_conversion_id_resume_async_post_without_preload_content(
        self,
        conversion_id: Annotated[StrictStr, Field(description="Conversion ID returned by POST /convert (UUID format)")],
        convert_resume_request: ConvertResumeRequest,
        _request_timeout: Union[
    ...
    def _resume_conversion_async_api_v1_convert_conversion_id_resume_async_post_serialize(
        self,
        conversion_id,
        convert_resume_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/convert/{conversion_id}/resume/async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
