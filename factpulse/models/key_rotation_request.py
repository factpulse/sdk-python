...
class KeyRotationRequest(BaseModel):
    ...
    """ # noqa: E501
    old_key: Annotated[str, Field(min_length=40, strict=True)] = Field(description="Current encryption key (base64-encoded AES-256)", alias="oldKey")
    new_key: Annotated[str, Field(min_length=40, strict=True)] = Field(description="New encryption key (base64-encoded AES-256)", alias="newKey")
    __properties: ClassVar[List[str]] = ["oldKey", "newKey"]
