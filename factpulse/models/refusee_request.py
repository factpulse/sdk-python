...
class RefuseeRequest(BaseModel):
    ...
    flow_type: Optional[StrictStr] = Field(default='SupplierInvoiceLC', description="Type de flux: SupplierInvoiceLC (acheteur) ou CustomerInvoiceLC (vendeur)", alias="flowType")
    ...
    reason_code: StrictStr = Field(description="Code motif du refus (obligatoire). Valeurs autorisées: TX_TVA_ERR, MONTANTTOTAL_ERR, CALCUL_ERR, NON_CONFORME, DOUBLON, DEST_ERR, TRANSAC_INC, EMMET_INC, CONTRAT_TERM, DOUBLE_FACT, CMD_ERR, ADR_ERR, REF_CT_ABSENT", alias="reasonCode")
    reason_text: Optional[StrictStr] = Field(default=None, alias="reasonText")
    __properties: ClassVar[List[str]] = ["invoiceId", "invoiceIssueDate", "senderSiren", "flowType", "pdpFlowServiceUrl", "pdpTokenUrl", "pdpClientId", "pdpClientSecret", "reasonCode", "reasonText"]
