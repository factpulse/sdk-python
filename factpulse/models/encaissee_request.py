...
class EncaisseeRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["invoiceId", "invoiceIssueDate", "senderSiren", "flowType", "pdpFlowServiceUrl", "pdpTokenUrl", "pdpClientId", "pdpClientSecret", "amount", "currency"]
