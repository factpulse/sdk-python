...
class ValidateEReportingResponse(BaseModel):
    ...
    errors: Optional[List[ValidationError]] = Field(default=None, description="List of validation errors (if any)")
    warnings: Optional[List[ValidationError]] = Field(default=None, description="List of validation warnings (if any)")
