...
------------ | ------------- | ------------- | -------------
**status** | **str** | Statut de la conversion | [optional] [default to 'validation_failed']
**conversion_id** | **str** | Identifiant unique de conversion | 
**message** | **str** | Message explicatif | [optional] [default to 'Donnees extraites avec erreurs de validation. Completez le formulaire et appelez /resume.']
