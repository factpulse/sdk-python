...
> TaskResponse verify_pdf_async_api_v1_verification_verify_async_post_0(pdf_file, force_ocr=force_ocr, callback_url=callback_url, webhook_mode=webhook_mode)
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        # Verify PDF/XML Factur-X compliance (asynchronous)
        api_response = api_instance.verify_pdf_async_api_v1_verification_verify_async_post_0(pdf_file, force_ocr=force_ocr, callback_url=callback_url, webhook_mode=webhook_mode)
