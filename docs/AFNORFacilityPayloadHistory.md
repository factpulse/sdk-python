...
afnor_facility_payload_history_instance = AFNORFacilityPayloadHistory.from_json(json)
# print the JSON string representation of the object
print(AFNORFacilityPayloadHistory.to_json())

# convert the object into a dict
afnor_facility_payload_history_dict = afnor_facility_payload_history_instance.to_dict()
# create an instance of AFNORFacilityPayloadHistory from a dict
afnor_facility_payload_history_from_dict = AFNORFacilityPayloadHistory.from_dict(afnor_facility_payload_history_dict)
```
