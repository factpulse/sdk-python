...
with factpulse.ApiClient(configuration) as api_client:
    ...
    api_instance = factpulse.TraitementFactureApi(api_client)
    ...
    try:
        ...
        print("The response of TraitementFactureApi->generer_certificat_test_api_v1_traitement_generer_certificat_test_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->generer_certificat_test_api_v1_traitement_generer_certificat_test_post: %s\n" % e)
```
...
> ReponseTache generer_facture_api_v1_traitement_generer_facture_post(donnees_facture, profil=profil, format_sortie=format_sortie, auto_enrichir=auto_enrichir, source_pdf=source_pdf)
...
with factpulse.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = factpulse.TraitementFactureApi(api_client)
    donnees_facture = 'donnees_facture_example' # str | Données de la facture au format JSON.              Deux formats acceptés :             1. **Format classique** : Structure complète FactureFacturX (tous les champs)             2. **Format simplifié** (🆕 P0.1) : Structure minimale avec auto-enrichissement              Le format est détecté automatiquement !             
    profil = factpulse.ProfilAPI() # ProfilAPI | Profil Factur-X : MINIMUM, BASIC, EN16931 ou EXTENDED. (optional)
    format_sortie = factpulse.FormatSortie() # FormatSortie | Format de sortie : 'xml' (XML seul) ou 'pdf' (PDF Factur-X avec XML embarqué). (optional)
    auto_enrichir = True # bool | 🆕 Activer l'auto-enrichissement depuis SIRET/SIREN (format simplifié uniquement) (optional) (default to True)
    source_pdf = None # bytearray |  (optional)

    try:
        # Générer une facture Factur-X
        api_response = api_instance.generer_facture_api_v1_traitement_generer_facture_post(donnees_facture, profil=profil, format_sortie=format_sortie, auto_enrichir=auto_enrichir, source_pdf=source_pdf)
        print("The response of TraitementFactureApi->generer_facture_api_v1_traitement_generer_facture_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->generer_facture_api_v1_traitement_generer_facture_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **donnees_facture** | **str**| Données de la facture au format JSON.              Deux formats acceptés :             1. **Format classique** : Structure complète FactureFacturX (tous les champs)             2. **Format simplifié** (🆕 P0.1) : Structure minimale avec auto-enrichissement              Le format est détecté automatiquement !              | 
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        # Obtenir le statut d'une tâche de génération
        api_response = api_instance.obtenir_statut_tache_api_v1_traitement_taches_id_tache_statut_get(id_tache)
        print("The response of TraitementFactureApi->obtenir_statut_tache_api_v1_traitement_taches_id_tache_statut_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->obtenir_statut_tache_api_v1_traitement_taches_id_tache_statut_get: %s\n" % e)
```
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TraitementFactureApi->signer_pdf_api_v1_traitement_signer_pdf_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->signer_pdf_api_v1_traitement_signer_pdf_post: %s\n" % e)
```
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TraitementFactureApi->signer_pdf_async_api_v1_traitement_signer_pdf_async_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->signer_pdf_async_api_v1_traitement_signer_pdf_async_post: %s\n" % e)
```
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TraitementFactureApi->soumettre_facture_complete_api_v1_traitement_factures_soumettre_complete_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->soumettre_facture_complete_api_v1_traitement_factures_soumettre_complete_post: %s\n" % e)
```
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TraitementFactureApi->soumettre_facture_complete_async_api_v1_traitement_factures_soumettre_complete_async_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->soumettre_facture_complete_async_api_v1_traitement_factures_soumettre_complete_async_post: %s\n" % e)
```
...
> ResultatValidationPDFAPI valider_pdf_facturx_api_v1_traitement_valider_pdf_facturx_post(fichier_pdf, profil=profil, use_verapdf=use_verapdf)
...
with factpulse.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = factpulse.TraitementFactureApi(api_client)
    fichier_pdf = None # bytearray | Fichier PDF Factur-X à valider (format .pdf).
    profil = factpulse.ProfilAPI() # ProfilAPI |  (optional)
    use_verapdf = False # bool | Active la validation stricte PDF/A avec VeraPDF (recommandé pour la production). Si False, utilise une validation basique par métadonnées. (optional) (default to False)

    try:
        # Valider un PDF Factur-X complet
        api_response = api_instance.valider_pdf_facturx_api_v1_traitement_valider_pdf_facturx_post(fichier_pdf, profil=profil, use_verapdf=use_verapdf)
        print("The response of TraitementFactureApi->valider_pdf_facturx_api_v1_traitement_valider_pdf_facturx_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->valider_pdf_facturx_api_v1_traitement_valider_pdf_facturx_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **fichier_pdf** | **bytearray**| Fichier PDF Factur-X à valider (format .pdf). | 
...
> ReponseTache valider_pdf_facturx_async_api_v1_traitement_valider_facturx_async_post(fichier_pdf, profil=profil, use_verapdf=use_verapdf)
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    fichier_pdf = None # bytearray | Fichier PDF Factur-X à valider (format .pdf).
    profil = factpulse.ProfilAPI() # ProfilAPI |  (optional)
    use_verapdf = False # bool | Active la validation stricte PDF/A avec VeraPDF (recommandé pour la production). Peut prendre plusieurs secondes. (optional) (default to False)

    try:
        # Valider un PDF Factur-X (asynchrone avec polling)
        api_response = api_instance.valider_pdf_facturx_async_api_v1_traitement_valider_facturx_async_post(fichier_pdf, profil=profil, use_verapdf=use_verapdf)
        print("The response of TraitementFactureApi->valider_pdf_facturx_async_api_v1_traitement_valider_facturx_async_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->valider_pdf_facturx_async_api_v1_traitement_valider_facturx_async_post: %s\n" % e)
```
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of TraitementFactureApi->valider_signature_pdf_endpoint_api_v1_traitement_valider_signature_pdf_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->valider_signature_pdf_endpoint_api_v1_traitement_valider_signature_pdf_post: %s\n" % e)
```
...
> ReponseValidationSucces valider_xml_api_v1_traitement_valider_xml_post(fichier_xml, profil=profil)
...
with factpulse.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = factpulse.TraitementFactureApi(api_client)
    fichier_xml = None # bytearray | Fichier XML Factur-X à valider (format .xml).
    profil = factpulse.ProfilAPI() # ProfilAPI | Profil de validation (MINIMUM, BASIC, EN16931, EXTENDED). (optional)

    try:
        # Valider un XML Factur-X existant
        api_response = api_instance.valider_xml_api_v1_traitement_valider_xml_post(fichier_xml, profil=profil)
        print("The response of TraitementFactureApi->valider_xml_api_v1_traitement_valider_xml_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TraitementFactureApi->valider_xml_api_v1_traitement_valider_xml_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **fichier_xml** | **bytearray**| Fichier XML Factur-X à valider (format .xml). | 
