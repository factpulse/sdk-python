...
with factpulse.ApiClient(configuration) as api_client:
    ...
    api_instance = factpulse.FacturXPDFXMLVerificationApi(api_client)
    task_id = 'task_id_example' # str | Celery task ID returned by /verify-async endpoint

    try:
        # Get status of an asynchronous verification
        api_response = api_instance.get_verification_status_api_v1_verification_verify_async_task_id_status_get(task_id)
        print("The response of FacturXPDFXMLVerificationApi->get_verification_status_api_v1_verification_verify_async_task_id_status_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FacturXPDFXMLVerificationApi->get_verification_status_api_v1_verification_verify_async_task_id_status_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **task_id** | **str**| Celery task ID returned by /verify-async endpoint | 
...
> TaskResponse verify_pdf_async_api_v1_verification_verify_async_post(pdf_file, force_ocr=force_ocr, callback_url=callback_url, webhook_mode=webhook_mode)
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        # Verify PDF/XML Factur-X compliance (asynchronous)
        api_response = api_instance.verify_pdf_async_api_v1_verification_verify_async_post(pdf_file, force_ocr=force_ocr, callback_url=callback_url, webhook_mode=webhook_mode)
        print("The response of FacturXPDFXMLVerificationApi->verify_pdf_async_api_v1_verification_verify_async_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FacturXPDFXMLVerificationApi->verify_pdf_async_api_v1_verification_verify_async_post: %s\n" % e)
```
...
with factpulse.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of FacturXPDFXMLVerificationApi->verify_pdf_sync_api_v1_verification_verify_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling FacturXPDFXMLVerificationApi->verify_pdf_sync_api_v1_verification_verify_post: %s\n" % e)
```
