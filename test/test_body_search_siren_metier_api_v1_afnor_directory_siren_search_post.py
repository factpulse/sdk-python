...
class TestBodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost(unittest.TestCase):
    """BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost:
        """Test BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost`
        """
        model = BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost()
        if include_optional:
            return BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost(
                criteria = { },
    ...
    def testBodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost(self):
        """Test BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost"""
