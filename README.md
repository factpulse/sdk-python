...
*AFNORDirectoryServiceMtierApi* | [**get_siren_metier_api_v1_afnor_directory_siren_siren_get**](docs/AFNORDirectoryServiceMtierApi.md#get_siren_metier_api_v1_afnor_directory_siren_siren_get) | **GET** /api/v1/afnor/directory/siren/{siren} | Récupérer une entreprise par SIREN (multi-tenant)
*AFNORDirectoryServiceMtierApi* | [**get_siret_metier_api_v1_afnor_directory_siret_siret_get**](docs/AFNORDirectoryServiceMtierApi.md#get_siret_metier_api_v1_afnor_directory_siret_siret_get) | **GET** /api/v1/afnor/directory/siret/{siret} | Récupérer un établissement par SIRET (multi-tenant)
*AFNORDirectoryServiceMtierApi* | [**search_siren_metier_api_v1_afnor_directory_siren_search_post**](docs/AFNORDirectoryServiceMtierApi.md#search_siren_metier_api_v1_afnor_directory_siren_search_post) | **POST** /api/v1/afnor/directory/siren/search | Rechercher des entreprises (multi-tenant)
*AFNORDirectoryServiceMtierApi* | [**search_siret_metier_api_v1_afnor_directory_siret_search_post**](docs/AFNORDirectoryServiceMtierApi.md#search_siret_metier_api_v1_afnor_directory_siret_search_post) | **POST** /api/v1/afnor/directory/siret/search | Rechercher des établissements (multi-tenant)
...
## Documentation For Models
 ...
 - [BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost](docs/BodySearchSirenMetierApiV1AfnorDirectorySirenSearchPost.md)
 - [BodySearchSiretMetierApiV1AfnorDirectorySiretSearchPost](docs/BodySearchSiretMetierApiV1AfnorDirectorySiretSearchPost.md)
